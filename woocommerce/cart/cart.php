...
<div class="cart-wrapper sm-touch-scroll">
	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		...
		<tbody>
					...
					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
                        ...
                        <td class="product-remove">
                            ...
                            echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                ...
                                sprintf(
                                    '<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s"><img class="" src="/wp-content/uploads/2024/04/Icon-1.svg"/></a>',
			...
			<tr>
				<td colspan="3" class="actions clear">
				...
				<td colspan="2" class="actions clear">
					<a href="<?php echo add_query_arg( 'clear-cart', 'true', site_url()); ?>" class="clear-cart"><?php esc_html_e( 'Clear cart', 'flatsome-child' ); ?></a>
				</td>
			</tr>
